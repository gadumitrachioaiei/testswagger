...
type ClientService interface {
	GetHealth(params *GetHealthParams, opts ...ClientOption) (*GetHealthNoContent, error)
...
*/
func (a *Client) GetHealth(params *GetHealthParams, opts ...ClientOption) (*GetHealthNoContent, error) {
	...
	success, ok := result.(*GetHealthNoContent)
	if ok {
		return success, nil
	}
